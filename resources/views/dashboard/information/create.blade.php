...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Buat Informasi</h1>
<p class="mb-4">Halaman ini untuk membuat informasi pada aplikasi.</p>
    ...
    <div class="card-body">
        <form action="{{route('dashboard.information.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control-file  @error('image') is-invalid @enderror" type="file" id="image"
            ...
            <div class="d-flex" style="justify-content: center">
                <button type="submit" class="btn btn-primary px-3">Tambahkan</button>
            </div>
        </form>
    </div>
</div>
