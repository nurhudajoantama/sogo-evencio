...
<form action="{{route('dashboard.information.update', $information)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <img src="{{ asset('storage/' . $information->image) }}" class="img-preview img-fluid mb-4 col-sm-2 d-block">
        @else
        <img class="img-preview img-fluid mb-4 col-sm-2">
        @endif
        <input class="form-control border-creatinformation @error('image') is-invalid @enderror" type="file" id="image" name="image"
    ...
    <div>
        <label class="" style="margin-top: 20px" for="video">Url Video</label>
